...
mydb = mysql.connector.connect(host = "localhost", user = "root", password = "SOUJASH", database = "department")
cursorObject = mydb.cursor()

def createDepartment(department_id, department_name):
    mydb1 = mysql.connector.connect(host = "localhost", user = "root", password = "SOUJASH", database = "batch")
